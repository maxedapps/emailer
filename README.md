...
- Listings page in created order. `--limit` is 1–100, default 25. A page's `nextCursor` is absent when there is nothing more; a full last page may still carry one that leads to an empty page.
