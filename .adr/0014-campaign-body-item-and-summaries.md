...
- Authority: The user decided on 2026-09-16, after the review of [PR #7](https://github.com/maxedapps/emailer/pull/7), that a campaign listing must not carry the body, and asked for the cleanest fix with big refactors allowed. The user then asked for the implementation of [the plan](work/campaign-body-item.md). Confirmation follows the plan's live gate.
