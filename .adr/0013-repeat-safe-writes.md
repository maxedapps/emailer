...
- Superseded in part: [ADR-0024](0024-typed-errors-and-cost-neutral-storage.md) for the AWS client's implicit default retry policy. Every function provides the default policy, stopped when its next delay would end past four seconds.
