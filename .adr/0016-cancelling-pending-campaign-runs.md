...
- Would supersede in part: [ADR-0015](0015-one-shot-scheduler-per-campaign.md), for cancellation transitions, removing run tokens, campaign-named schedules and delete-before-create replacement; [ADR-0013](0013-repeat-safe-writes.md), for the single-item update mechanism used by campaign lifecycle commands.
